...
# modification of paper/robustfigs.py: do not show SS results
...
plt.xlabel(r'$\Delta x$ (km)', fontsize=20.0, labelpad=1)
plt.xticks([500, 1000, 2500, 5000], ('0.5', '1', '2.5', '5'), fontsize=12.0)
klist = np.arange(5)
plt.ylabel(r'$\epsilon_i$ of convergence failure', fontsize=16.0, labelpad=1)
ax = plt.axes()
ax.xaxis.grid(True)
ax.yaxis.grid(False)
