...
$$h_t + \Div\bq = f \qquad \to \qquad \frac{H_n - H_{n-1}}{\Delta t} + \Div \bQ_n = F_n$$
  ...
  \item the new equation (right) is a ``single time-step problem''
    \begin{itemize}
...
\begin{frame}{Compare 1D examples}
...
\bigskip
\includegraphics[width=0.6\textwidth,keepaspectratio=true]{masstimeseries}
\end{center}
\end{frame}


\subsection{Weak numerical free boundary solutions.}
