...
\section{free-boundary fluid layer models}
...
\section{semi-discretize in time}
...
\section{each time-step is weakly-posed free-bdry problem}
...
\begin{frame}{aeak solves strong but gives more info}
...
\section{Newton solvers for NCPs}
