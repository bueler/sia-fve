...
FIXME: implicit by Newton, but using reduced-set \citep{BensonMunson2006} and Jacobian calculation by finite differencing.  thus only need to write a residual routine.

FIXME: continuation on $n$ and on $D$
