...
\subsection{Classical Mahaffy scheme}   \label{subsec:mahaffyfd}
...
\subsection{FVE re-interpretation} \label{subsec:fveinterpretation}
...
\subsection{Improved scheme}  \label{subsec:star}
...
\subsection{Solution of the equations} \label{subsec:solution}
