...
FIXME: point out that $\bq$ is not a differentiable function of the components of $\grad H$ if $n<3$, which means that problem requires regularization
