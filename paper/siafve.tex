...
\caption{Our method computes high-resolution ice sheet margins at the locations determined only by the surface mass balance, bedrock topography, and the steady-state, simplified-dynamics SIA model.  Here: 900 m model resolution using the \MCB (see text) bed topography data.}
\label{fig:grnwinset}
\end{figure}
