...
Thus we see good results from our implicit, first-order upwinding \Mstar scheme.  FIXME  Our bit of upwinding seems adequately helpful to Newton convergence, and the accuracy is satisfactory.
