...
\begin{align*}
1 - \frac{y_1}{\left( \sqrt{y_1^2+y_2^2} \right)^{2-p}}
      &\ge \begin{cases} 1-y_1, & y_1 \le 0, \\
                        1-\frac{y_1}{y_1^{2-p}}, & 0 \le y_1 \le 1 \end{cases}\Bigg\} \\
      &\ge \begin{cases} 1-y_1, & y_1 \le 0, \\
                        1-y_1^{p-1}, & 0 \le y_1 \le 1 \end{cases}\Bigg\}
      \ge (p-1) (1-y_1).
\end{align*}
(The lower case in the last inequality is easy to prove by the mean-value-theorem applied to $\varphi(t)=t^{p-1}$, for which $\varphi'(1)=p-1$.)  Also noting $(y_1^2+y_2^2)^{\frac{p-2}{2}} \ge 1$ and $\left(1 + \sqrt{y_1^2+y_2^2} \right)^{2-p} \ge 1$, because $|y|\le 1$ and $p-2\le 0$, thus
\begin{align*}
