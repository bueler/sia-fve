...
\end{equation}
needs to be continuous.  But now the linearity of the integral, and the almost-forgotton continuity assumptions \eqref{eq:Qiscontinuous} and \eqref{eq:Fislip}, show that $g$ is indeed continuous.  Thus $\An$ is continuous on finite-dimensional subspaces.
