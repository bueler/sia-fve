...
\item define
	\begin{align*}
	\Omega_n &= \operatorname{supp} H_n = \left\{x \in \Omega\,\Big|\,H_n(x) > 0\right\} \\
	\Omega_n^r &= \left\{x \in \Omega\,\Big|\,H_n(x)= 0 \text{ and } H_{n-1}(x) > 0\right\} \quad \text{\alert{$\leftarrow$ retreat set}}
	\end{align*}
\end{itemize}
...
\begin{center}
\animategraphics[autoplay,loop,height=4cm]{6}{anim/u-}{1}{25}
\end{center}
\end{frame}
